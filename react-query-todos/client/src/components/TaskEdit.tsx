  ...
  return (
    <div>
      <form onSubmit={submitHandler}>
        <input
          className="mb-3 ps-3 py-2 border border-gray-300"
        ...
        />
        <button
          className="disabled:opacity-40 my-3 py-3 mx-3 py-2 px-3 text-white bg-indigo-600 hover:bg-indigo-700 rounded"
